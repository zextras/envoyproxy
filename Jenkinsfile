            ...
            parallel {
                stage('Ubuntu 16.04') {
                    ...
                    steps {
                        ...
                        sh 'sudo cp /pacur/envoyproxy_*.deb artifacts/'
                        dir("artifacts/") {
                            sh 'echo envoyproxy* | sed -E "s#(envoyproxy_[0-9.]*).*#\\0 \\1_amd64.deb#" | xargs mv'
                        }
                ...
                stage('Centos 7') {
                    ...
                    steps {
                        ...
                        sh 'sudo cp /pacur/envoyproxy*.rpm artifacts/'
                        dir("artifacts/") {
                            sh 'echo envoyproxy* | sed -E "s#(envoyproxy-[0-9.]*).*#\\0 \\1.x86_64.rpm#" | xargs mv'
                        }
